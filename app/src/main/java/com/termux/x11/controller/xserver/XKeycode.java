...
public enum XKeycode {
    ...
    KEY_KP_5(76, 65453),
    KEY_KP_6(77, 65454),
    KEY_KP_PLUS(78, 65451),
    KEY_KP_1(79, 65449),
    KEY_KP_2(80, 65450),
    KEY_KP_3(81, 65451),
    KEY_KP_0(82, 65448),
    KEY_KP_DECIMAL(83, 65454),
    KEY_F11(87, 65482),
    KEY_F12(88, 65483),
    KEY_HOME(91, 65360),
    KEY_UP(92, 65362),
    KEY_PAGE_UP(93, 65365),
    KEY_LEFT(94, 65361),
    KEY_RIGHT(95, 65363),
    KEY_END(96, 65367),
    KEY_DOWN(97, 65364),
    KEY_PAGE_DOWN(98, 65366),
    KEY_INSERT(99, 65379),
    KEY_DELETE(100, 65535),
    KEY_PAUSE(127, 65377),
    KEY_PRINT(99, 65377),
    KEY_LEFTMETA(110, 65513),
    KEY_RIGHTMETA(115, 65514),
    KEY_COMPOSE(127, 65383),
    KEY_SHIFT_L(KEY_LEFTSHIFT.code, KEY_LEFTSHIFT.id),
    KEY_SHIFT_R(KEY_RIGHTSHIFT.code, KEY_RIGHTSHIFT.id),
    KEY_CTRL_L(KEY_LEFTCTRL.code, KEY_LEFTCTRL.id),
    KEY_CTRL_R(KEY_RIGHTCTRL.code, KEY_RIGHTCTRL.id),
    KEY_ALT_L(KEY_LEFTALT.code, KEY_LEFTALT.id),
    KEY_ALT_R(KEY_RIGHTALT.code, KEY_RIGHTALT.id),
    KEY_BKSP(KEY_BACKSPACE.code, KEY_BACKSPACE.id),
    KEY_ESCAPE(KEY_ESC.code, KEY_ESC.id),
    KEY_DEL(KEY_DELETE.code, KEY_DELETE.id),
    KEY_PRIOR(KEY_PAGE_UP.code, KEY_PAGE_UP.id),
    KEY_NEXT(KEY_PAGE_DOWN.code, KEY_PAGE_DOWN.id),
    KEY_PRTSCN(KEY_PRINT.code, KEY_PRINT.id),
    KEY_TAB_ALT(KEY_TAB.code, KEY_TAB.id),
